...
const burger=document.querySelector(".menu__burger"),menuNav=document.querySelector(".menu__nav");function show(){burger.classList.contains("show")?(burger.classList.remove("show"),menuNav.classList.remove("show")):(burger.classList.add("show"),menuNav.classList.add("show"))}burger.addEventListener("click",show);const catalogDescr=document.querySelectorAll(".catalog__descr"),catalogItems=document.querySelectorAll(".catalog__item");lightGallery(document.getElementById("lightgallery"));const mySlider=new Swiper(".slider__wrapper",{navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{el:".swiper-pagination",clickable:!0},slidesPerView:1,slidesPerGroup:1,loop:!0,spaceBetween:2}),links=document.querySelectorAll(".menu__link"),before=document.querySelector(".menu__list").querySelectorAll("li");console.log(before),window.addEventListener("scroll",()=>{window.pageYOffset>=200?(links.forEach(e=>{e.classList.add("menu__color")}),before.forEach(e=>{e.classList.add("bb")})):(links.forEach(e=>{e.classList.remove("menu__color")}),before.forEach(e=>{e.classList.remove("bb")}))});const anchors=document.querySelectorAll('a[href*="#"]');for(let e of anchors)e.addEventListener("click",(function(o){o.preventDefault();const t=e.getAttribute("href").substr(1);console.log(t),document.getElementById(t).scrollIntoView({behavior:"smooth",block:"start"})}));